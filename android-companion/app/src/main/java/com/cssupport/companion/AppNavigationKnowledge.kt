    ...
    private val profiles = mapOf(
        ...
        "in.swiggy.android" to AppNavProfile(
            ...
            supportPath = listOf(
                ...
                "If you see 'LOGIN' or 'Login/Create Account': the user is NOT logged in — call request_human_review immediately saying 'Please log in to Swiggy first'",
                "If logged in: Tap \"My Orders\" or \"Your Orders\" in the account menu",
                "Select the specific order with the issue",
                "Tap \"Help\" on the order details page",
                "Choose the relevant issue category (e.g., \"Missing items\", \"Wrong order\", \"Late delivery\")",
                "If given option buttons: click the one closest to the issue. The chatbot uses menus, not free text.",
                "Tap \"Chat with Us\" or \"Talk to agent\" for live chat support if available",
            ),
            pitfalls = listOf(
                ...
                "If the ACCOUNT page shows a 'LOGIN' button and 'Login/Create Account' text, the user is NOT logged in — call request_human_review IMMEDIATELY. Do NOT try to navigate further.",
                "Do NOT click \"Send Feedback\" — it opens app feedback, not customer support",
                "Do NOT click \"Offers\" — it shows discount offers, not customer support",
                "\"SWIGGY\" tab (leftmost in bottom bar) shows the food home page — not support",
                "Swiggy support is chatbot-based — you will see option buttons to click, not a free-text input initially",
            ),
